 ...
 * @version v1.0
 * @function 用户信息-基本信息管理
 * @info java springMVC
 * @update 无
 */
@Controller
@Scope("prototype")
@RequestMapping("master/user1info")
public class MasterUser1infoController  extends BaseController{

    @Autowired
    private User1infoService user1infoService;

    private String list = "/master/user1info/list";
    private String edit = "/master/user1info/edit";
    private String reList = "redirect:" + list;
    private String addAction = "master/user1info/add";
    private String uptAction = "master/user1info/upt";
    private String delAction = "master/user1info/del";
    ...
    public Map<String, Object> list(@RequestParam(value = "s", required = false, defaultValue = "1") int start,
        ...
        //  返回参数
        List<User1info> lists = user1infoService.queryAll(params);
        Long count = user1infoService.queryCount(params);
    ...
    public String add(User1info m,Model model) {
        model.addAttribute("action", addAction);
        model.addAttribute("title", addTitle);
        model.addAttribute("m", m);
        // 验证
    ...
    public String upt(@PathVariable("id") String id,Model model) {
        ...
        User1info m = user1infoService.queryBean(id);
        model.addAttribute("m", m);
        return edit;
    }
    ...
    public String upt(User1info m,Model model) {
        model.addAttribute("action", uptAction);
        model.addAttribute("title", uptTitle);
        model.addAttribute("m", m);
        // 验证
    ...
    public String del(@PathVariable("id") String id) {
        user1infoService.deleteBean(id);
        return reList;
    }
