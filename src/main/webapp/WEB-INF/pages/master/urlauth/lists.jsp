...
<body>
							...
							<div class="panel-body">
								...
								<div class="form-inline">
									...
									<div class="form-group">
										...
										<a class="btn btn-primary" href="/master/urlauth/add">增加&nbsp;<i class="fa fa-plus"></i></a>
									</div>
								</div>
	...
	<script type="text/javascript">
		...
		function del(id){
			if(confirm("确认删除吗?")){
				window.location.href="${path}/master/urlauth/del/"+id;
			}
		}
		...
		//加载函数
		function loadTab(s){
			var url="${path}/master/urlauth/lists";
			var ps={"s":s};
				ps.u=$("#name").val();
			...
			$.post(url,ps,function(json){
				if(json.count>0){
					...
					$.each(json.datas,function(i,d){
						...
						html+='<a href="${path}/master/urlauth/upt/'+(d.id)+'" class="btn btn-primary  btn-xs"><i class="fa fa-pencil"></i>&nbsp;编辑</a>&nbsp;';
