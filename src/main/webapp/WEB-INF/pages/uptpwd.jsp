...
<body class="login-body">
	...
	<div class="container">
		...
		<form class="form-signin" action="${path}/uptpwd" method="post">
			<h2 class="form-signin-heading">修改密码</h2>
			
			<div class="login-wrap">
				<p id="error" style="color: red;">${error}&nbsp;</p>
				
				<input type="password" class="form-control" name="p" placeholder="原密码" autofocus autocomplete="off"> 
				
				<input type="password" class="form-control" name="p1" placeholder="新密码" autofocus autocomplete="off"> 
